...
/* build.c */
extern "C" int p7_Handmodelmaker(ESL_MSA *msa,                P7_BUILDER *bld, P7_HMM **ret_hmm, P7_TRACE ***ret_tr);
extern "C" int p7_Fastmodelmaker(ESL_MSA *msa, float symfrac, P7_BUILDER *bld, P7_HMM **ret_hmm, P7_TRACE ***ret_tr);

/* emit.c */
extern "C" int p7_CoreEmit   (ESL_RANDOMNESS *r, const P7_HMM *hmm,                                        ESL_SQ *sq, P7_TRACE *tr);
extern "C" int p7_ProfileEmit(ESL_RANDOMNESS *r, const P7_HMM *hmm, const P7_PROFILE *gm, const P7_BG *bg, ESL_SQ *sq, P7_TRACE *tr);
extern "C" int p7_emit_SimpleConsensus(const P7_HMM *hmm, ESL_SQ *sq);
extern "C" int p7_emit_FancyConsensus (const P7_HMM *hmm, float min_lower, float min_upper, ESL_SQ *sq);

/* errors.c */
extern "C" void p7_Die (char *format, ...);
extern "C" void p7_Fail(char *format, ...);

/* evalues.c */
extern "C" int p7_Calibrate(P7_HMM *hmm, P7_BUILDER *cfg_b, ESL_RANDOMNESS **byp_rng, P7_BG **byp_bg, P7_PROFILE **byp_gm, P7_OPROFILE **byp_om);
extern "C" int p7_Lambda(P7_HMM *hmm, P7_BG *bg, double *ret_lambda);
extern "C" int p7_MSVMu     (ESL_RANDOMNESS *r, P7_OPROFILE *om, P7_BG *bg, int L, int N, double lambda,               double *ret_mmu);
extern "C" int p7_ViterbiMu (ESL_RANDOMNESS *r, P7_OPROFILE *om, P7_BG *bg, int L, int N, double lambda,               double *ret_vmu);
extern "C" int p7_Tau       (ESL_RANDOMNESS *r, P7_OPROFILE *om, P7_BG *bg, int L, int N, double lambda, double tailp, double *ret_tau);

/* eweight.c */
extern "C" int p7_EntropyWeight(const P7_HMM *hmm, const P7_BG *bg, const P7_PRIOR *pri, double infotarget, double *ret_Neff);


/* generic_decoding.c */
extern "C" int p7_GDecoding      (const P7_PROFILE *gm, const P7_GMX *fwd,       P7_GMX *bck, P7_GMX *pp);
extern "C" int p7_GDomainDecoding(const P7_PROFILE *gm, const P7_GMX *fwd, const P7_GMX *bck, P7_DOMAINDEF *ddef);

/* generic_fwdback.c */
extern "C" int p7_GForward     (const ESL_DSQ *dsq, int L, const P7_PROFILE *gm,       P7_GMX *gx, float *ret_sc);
extern "C" int p7_GBackward    (const ESL_DSQ *dsq, int L, const P7_PROFILE *gm,       P7_GMX *gx, float *ret_sc);
extern "C" int p7_GHybrid      (const ESL_DSQ *dsq, int L, const P7_PROFILE *gm,       P7_GMX *gx, float *opt_fwdscore, float *opt_hybscore);

/* generic_msv.c */
extern "C" int p7_GMSV           (const ESL_DSQ *dsq, int L, const P7_PROFILE *gm, P7_GMX *gx, float nu, float *ret_sc);
extern "C" int p7_GMSV_longtarget(const ESL_DSQ *dsq, int L, P7_PROFILE *gm, P7_GMX *gx, float nu,  P7_BG *bg, double P, P7_HMM_WINDOWLIST *windowlist);

/* generic_null2.c */
extern "C" int p7_GNull2_ByExpectation(const P7_PROFILE *gm, P7_GMX *pp, float *null2);
extern "C" int p7_GNull2_ByTrace      (const P7_PROFILE *gm, const P7_TRACE *tr, int zstart, int zend, P7_GMX *wrk, float *null2);

/* generic_optacc.c */
extern "C" int p7_GOptimalAccuracy(const P7_PROFILE *gm, const P7_GMX *pp,       P7_GMX *gx, float *ret_e);
extern "C" int p7_GOATrace        (const P7_PROFILE *gm, const P7_GMX *pp, const P7_GMX *gx, P7_TRACE *tr);

/* generic_stotrace.c */
extern "C" int p7_GStochasticTrace(ESL_RANDOMNESS *r, const ESL_DSQ *dsq, int L, const P7_PROFILE *gm, const P7_GMX *gx, P7_TRACE *tr);

/* generic_viterbi.c */
extern "C" int p7_GViterbi     (const ESL_DSQ *dsq, int L, const P7_PROFILE *gm,       P7_GMX *gx, float *ret_sc);

/* generic_vtrace.c */
extern "C" int p7_GTrace       (const ESL_DSQ *dsq, int L, const P7_PROFILE *gm, const P7_GMX *gx, P7_TRACE *tr);
extern "C" int p7_GViterbi_longtarget(const ESL_DSQ *dsq, int L, const P7_PROFILE *gm, P7_GMX *gx,
                       float filtersc, double P, P7_HMM_WINDOWLIST *windowlist);


/* heatmap.c (evolving now, intend to move this to Easel in the future) */
extern "C" double dmx_upper_max(ESL_DMATRIX *D);
extern "C" double dmx_upper_min(ESL_DMATRIX *D);
extern "C" double dmx_upper_element_sum(ESL_DMATRIX *D);
extern "C" double dmx_upper_norm(ESL_DMATRIX *D);
extern "C" int    dmx_Visualize(FILE *fp, ESL_DMATRIX *D, double min, double max);

/* hmmdutils.c */
extern "C" void p7_openlog(const char *ident, int option, int facility);
extern "C" void p7_syslog(int priority, const char *format, ...);
extern "C" void p7_closelog(void);

/* hmmlogo.c */
extern "C" float hmmlogo_maxHeight (P7_BG *bg);
extern "C" int hmmlogo_RelativeEntropy_all      (P7_HMM *hmm, P7_BG *bg, float *rel_ents, float **probs, float **heights );
extern "C" int hmmlogo_RelativeEntropy_above_bg (P7_HMM *hmm, P7_BG *bg, float *rel_ents, float **probs, float **heights );
extern "C" int hmmlogo_ScoreHeights (P7_HMM *hmm, P7_BG *bg, float **heights );
extern "C" int hmmlogo_IndelValues (P7_HMM *hmm, float *insert_P, float *insert_expL, float *delete_P );



/* hmmpgmd2msa.c */
extern "C" int hmmpgmd2msa(void *data, P7_HMM *hmm, ESL_SQ *qsq,  int *incl, int incl_size, int *excl, int excl_size, ESL_MSA **ret_msa);



/* island.c */
extern "C" int   p7_island_Viterbi(ESL_DSQ *dsq, int L, P7_PROFILE *gm, P7_GMX *mx, ESL_HISTOGRAM *h);

/* h2_io.c */
extern "C" int   p7_h2io_WriteASCII(FILE *fp, P7_HMM *hmm);

/* hmmer.c */
extern "C" void         p7_banner(FILE *fp, char *progname, char *banner);
extern "C" ESL_GETOPTS *p7_CreateDefaultApp(ESL_OPTIONS *options, int nargs, int argc, char **argv, char *banner, char *usage);
extern "C" int          p7_AminoFrequencies(float *f);

/* logsum.c */
extern "C" int   p7_FLogsumInit(void);
extern "C" float p7_FLogsum(float a, float b);
extern "C" float p7_FLogsumError(float a, float b);
extern "C" int   p7_ILogsumInit(void);
extern "C" int   p7_ILogsum(int s1, int s2);


/* modelconfig.c */
extern "C" int p7_ProfileConfig(const P7_HMM *hmm, const P7_BG *bg, P7_PROFILE *gm, int L, int mode);
extern "C" int p7_ReconfigLength  (P7_PROFILE *gm, int L);
extern "C" int p7_ReconfigMultihit(P7_PROFILE *gm, int L);
extern "C" int p7_ReconfigUnihit  (P7_PROFILE *gm, int L);

/* modelstats.c */
extern "C" double p7_MeanMatchInfo           (const P7_HMM *hmm, const P7_BG *bg);
extern "C" double p7_MeanMatchEntropy        (const P7_HMM *hmm);
extern "C" double p7_MeanMatchRelativeEntropy(const P7_HMM *hmm, const P7_BG *bg);
extern "C" double p7_MeanForwardScore        (const P7_HMM *hmm, const P7_BG *bg);
extern "C" int    p7_MeanPositionRelativeEntropy(const P7_HMM *hmm, const P7_BG *bg, double *ret_entropy);
extern "C" int    p7_hmm_CompositionKLDist(P7_HMM *hmm, P7_BG *bg, float *ret_KL, float **opt_avp);


/* mpisupport.c */
#ifdef HAVE_MPI
extern "C" int p7_hmm_MPISend(P7_HMM *hmm, int dest, int tag, MPI_Comm comm, char **buf, int *nalloc);
extern "C" int p7_hmm_MPIPackSize(P7_HMM *hmm, MPI_Comm comm, int *ret_n);
extern "C" int p7_hmm_MPIPack(P7_HMM *hmm, char *buf, int n, int *position, MPI_Comm comm);
extern "C" int p7_hmm_MPIUnpack(char *buf, int n, int *pos, MPI_Comm comm, ESL_ALPHABET **abc, P7_HMM **ret_hmm);
extern "C" int p7_hmm_MPIRecv(int source, int tag, MPI_Comm comm, char **buf, int *nalloc, ESL_ALPHABET **abc, P7_HMM **ret_hmm);

extern "C" int p7_profile_MPISend(P7_PROFILE *gm, int dest, int tag, MPI_Comm comm, char **buf, int *nalloc);
extern "C" int p7_profile_MPIRecv(int source, int tag, MPI_Comm comm, const ESL_ALPHABET *abc, const P7_BG *bg,
			      char **buf, int *nalloc,  P7_PROFILE **ret_gm);

extern "C" int p7_pipeline_MPISend(P7_PIPELINE *pli, int dest, int tag, MPI_Comm comm, char **buf, int *nalloc);
extern "C" int p7_pipeline_MPIRecv(int source, int tag, MPI_Comm comm, char **buf, int *nalloc, ESL_GETOPTS *go, P7_PIPELINE **ret_pli);

extern "C" int p7_tophits_MPISend(P7_TOPHITS *th, int dest, int tag, MPI_Comm comm, char **buf, int *nalloc);
extern "C" int p7_tophits_MPIRecv(int source, int tag, MPI_Comm comm, char **buf, int *nalloc, P7_TOPHITS **ret_th);

extern "C" int p7_oprofile_MPISend(P7_OPROFILE *om, int dest, int tag, MPI_Comm comm, char **buf, int *nalloc);
extern "C" int p7_oprofile_MPIPackSize(P7_OPROFILE *om, MPI_Comm comm, int *ret_n);
extern "C" int p7_oprofile_MPIPack(P7_OPROFILE *om, char *buf, int n, int *pos, MPI_Comm comm);
extern "C" int p7_oprofile_MPIUnpack(char *buf, int n, int *pos, MPI_Comm comm, ESL_ALPHABET **abc, P7_OPROFILE **ret_om);
extern "C" int p7_oprofile_MPIRecv(int source, int tag, MPI_Comm comm, char **buf, int *nalloc, ESL_ALPHABET **abc, P7_OPROFILE **ret_om);
#endif /*HAVE_MPI*/

/* tracealign.c */
extern "C" int p7_tracealign_Seqs(ESL_SQ **sq,           P7_TRACE **tr, int nseq, int M,  int optflags, P7_HMM *hmm, ESL_MSA **ret_msa);
extern "C" int p7_tracealign_MSA (const ESL_MSA *premsa, P7_TRACE **tr,           int M,  int optflags, ESL_MSA **ret_postmsa);
extern "C" int p7_tracealign_computeTraces(P7_HMM *hmm, ESL_SQ  **sq, int offset, int N, P7_TRACE  **tr);
extern "C" int p7_tracealign_getMSAandStats(P7_HMM *hmm, ESL_SQ  **sq, int N, ESL_MSA **ret_msa, float **ret_pp, float **ret_relent, float **ret_scores );

/* p7_alidisplay.c */
extern "C" P7_ALIDISPLAY *p7_alidisplay_Create(const P7_TRACE *tr, int which, const P7_OPROFILE *om, const ESL_SQ *sq);
extern "C" P7_ALIDISPLAY *p7_alidisplay_Clone(const P7_ALIDISPLAY *ad);
extern "C" size_t         p7_alidisplay_Sizeof(const P7_ALIDISPLAY *ad);
extern "C" int            p7_alidisplay_Serialize(P7_ALIDISPLAY *ad);
extern "C" int            p7_alidisplay_Deserialize(P7_ALIDISPLAY *ad);
extern "C" void           p7_alidisplay_Destroy(P7_ALIDISPLAY *ad);
extern "C" char           p7_alidisplay_EncodePostProb(float p);
extern "C" float          p7_alidisplay_DecodePostProb(char pc);
extern "C" char           p7_alidisplay_EncodeAliPostProb(float p, float hi, float med, float lo);
extern "C" int            p7_alidisplay_Print(FILE *fp, P7_ALIDISPLAY *ad, int min_aliwidth, int linewidth, int show_accessions);
extern "C" int            p7_alidisplay_Backconvert(const P7_ALIDISPLAY *ad, const ESL_ALPHABET *abc, ESL_SQ **ret_sq, P7_TRACE **ret_tr);
extern "C" int            p7_alidisplay_Dump(FILE *fp, const P7_ALIDISPLAY *ad);
extern "C" int            p7_alidisplay_Compare(const P7_ALIDISPLAY *ad1, const P7_ALIDISPLAY *ad2);

/* p7_bg.c */
extern "C" P7_BG *p7_bg_Create(const ESL_ALPHABET *abc);
extern "C" P7_BG *p7_bg_CreateUniform(const ESL_ALPHABET *abc);
extern "C" P7_BG *p7_bg_Clone(const P7_BG *bg);
extern "C" int    p7_bg_Dump(FILE *ofp, const P7_BG *bg);
extern "C" void   p7_bg_Destroy(P7_BG *bg);
extern "C" int    p7_bg_SetLength(P7_BG *bg, int L);
extern "C" int    p7_bg_NullOne(const P7_BG *bg, const ESL_DSQ *dsq, int L, float *ret_sc);

extern "C" int    p7_bg_Read(char *bgfile, P7_BG *bg, char *errbuf);
extern "C" int    p7_bg_Write(FILE *fp, P7_BG *bg);

extern "C" int    p7_bg_SetFilter  (P7_BG *bg, int M, const float *compo);
extern "C" int    p7_bg_FilterScore(P7_BG *bg, const ESL_DSQ *dsq, int L, float *ret_sc);

/* p7_builder.c */
extern "C" P7_BUILDER *p7_builder_Create(const ESL_GETOPTS *go, const ESL_ALPHABET *abc);
extern "C" int         p7_builder_LoadScoreSystem(P7_BUILDER *bld, const char *matrix,                  double popen, double pextend, P7_BG *bg);
extern "C" int         p7_builder_SetScoreSystem (P7_BUILDER *bld, const char *mxfile, const char *env, double popen, double pextend, P7_BG *bg);
extern "C" void        p7_builder_Destroy(P7_BUILDER *bld);

extern "C" int p7_Builder      (P7_BUILDER *bld, ESL_MSA *msa, P7_BG *bg, P7_HMM **opt_hmm, P7_TRACE ***opt_trarr, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, ESL_MSA **opt_postmsa);
extern "C" int p7_SingleBuilder(P7_BUILDER *bld, ESL_SQ *sq,   P7_BG *bg, P7_HMM **opt_hmm, P7_TRACE  **opt_tr,    P7_PROFILE **opt_gm, P7_OPROFILE **opt_om); 
extern "C" int p7_Builder_MaxLength      (P7_HMM *hmm, double emit_thresh);

/* p7_domaindef.c */
extern "C" P7_DOMAINDEF *p7_domaindef_Create (ESL_RANDOMNESS *r);
extern "C" int           p7_domaindef_Fetch  (P7_DOMAINDEF *ddef, int which, int *opt_i, int *opt_j, float *opt_sc, P7_ALIDISPLAY **opt_ad);
extern "C" int           p7_domaindef_GrowTo (P7_DOMAINDEF *ddef, int L);
extern "C" int           p7_domaindef_Reuse  (P7_DOMAINDEF *ddef);
extern "C" int           p7_domaindef_DumpPosteriors(FILE *ofp, P7_DOMAINDEF *ddef);
extern "C" void          p7_domaindef_Destroy(P7_DOMAINDEF *ddef);

extern "C" int p7_domaindef_ByViterbi            (P7_PROFILE *gm, const ESL_SQ *sq, P7_GMX *gx1, P7_GMX *gx2, P7_DOMAINDEF *ddef);
extern "C" int p7_domaindef_ByPosteriorHeuristics(const ESL_SQ *sq, P7_OPROFILE *om, P7_OMX *oxf, P7_OMX *oxb, P7_OMX *fwd, P7_OMX *bck,
				                                  P7_DOMAINDEF *ddef, P7_BG *bg, int long_target,
				                                  P7_BG *bg_tmp, float *scores_arr, float *fwd_emissions_arr);


/* p7_gmx.c */
extern "C" P7_GMX *p7_gmx_Create (int allocM, int allocL);
extern "C" int     p7_gmx_GrowTo (P7_GMX *gx, int allocM, int allocL);
extern "C" size_t  p7_gmx_Sizeof (P7_GMX *gx);
extern "C" int     p7_gmx_Reuse  (P7_GMX *gx);
extern "C" void    p7_gmx_Destroy(P7_GMX *gx);
extern "C" int     p7_gmx_Compare(P7_GMX *gx1, P7_GMX *gx2, float tolerance);
extern "C" int     p7_gmx_Dump(FILE *fp, P7_GMX *gx, int flags);
extern "C" int     p7_gmx_DumpWindow(FILE *fp, P7_GMX *gx, int istart, int iend, int kstart, int kend, int show_specials);


/* p7_hmm.c */
/*      1. The P7_HMM object: allocation, initialization, destruction. */
extern "C" P7_HMM *p7_hmm_Create(int M, const ESL_ALPHABET *abc);
extern "C" P7_HMM *p7_hmm_CreateShell(void);
extern "C" int     p7_hmm_CreateBody(P7_HMM *hmm, int M, const ESL_ALPHABET *abc);
extern "C" void    p7_hmm_Destroy(P7_HMM *hmm);
extern "C" int     p7_hmm_CopyParameters(const P7_HMM *src, P7_HMM *dest);
extern "C" P7_HMM *p7_hmm_Clone(const P7_HMM *hmm);
extern "C" int     p7_hmm_Zero(P7_HMM *hmm);
extern "C" char    p7_hmm_EncodeStatetype(char *typestring);
extern "C" char   *p7_hmm_DecodeStatetype(char st);
/*      2. Convenience routines for setting fields in an HMM. */
extern "C" int     p7_hmm_SetName       (P7_HMM *hmm, char *name);
extern "C" int     p7_hmm_SetAccession  (P7_HMM *hmm, char *acc);
extern "C" int     p7_hmm_SetDescription(P7_HMM *hmm, char *desc);
extern "C" int     p7_hmm_AppendComlog  (P7_HMM *hmm, int argc, char **argv);
extern "C" int     p7_hmm_SetCtime      (P7_HMM *hmm);
extern "C" int     p7_hmm_SetComposition(P7_HMM *hmm);
extern "C" int     p7_hmm_SetConsensus  (P7_HMM *hmm, ESL_SQ *sq);
/*      3. Renormalization and rescaling counts in core HMMs. */
extern "C" int     p7_hmm_Scale      (P7_HMM *hmm, double scale);
extern "C" int     p7_hmm_Renormalize(P7_HMM *hmm);
/*      4. Debugging and development code. */
extern "C" int     p7_hmm_Dump(FILE *fp, P7_HMM *hmm);
extern "C" int     p7_hmm_Sample          (ESL_RANDOMNESS *r, int M, const ESL_ALPHABET *abc, P7_HMM **ret_hmm);
extern "C" int     p7_hmm_SampleUngapped  (ESL_RANDOMNESS *r, int M, const ESL_ALPHABET *abc, P7_HMM **ret_hmm);
extern "C" int     p7_hmm_SampleEnumerable(ESL_RANDOMNESS *r, int M, const ESL_ALPHABET *abc, P7_HMM **ret_hmm);
extern "C" int     p7_hmm_SampleUniform   (ESL_RANDOMNESS *r, int M, const ESL_ALPHABET *abc, 
				     float tmi, float tii, float tmd, float tdd,  P7_HMM **ret_hmm);
extern "C" int     p7_hmm_Compare(P7_HMM *h1, P7_HMM *h2, float tol);
extern "C" int     p7_hmm_Validate(P7_HMM *hmm, char *errbuf, float tol);
/*      5. Other routines in the API */
extern "C" int     p7_hmm_CalculateOccupancy(const P7_HMM *hmm, float *mocc, float *iocc);



/* p7_hmmfile.c */
extern "C" int  p7_hmmfile_OpenE    (char *filename, char *env, P7_HMMFILE **ret_hfp, char *errbuf);
extern "C" int  p7_hmmfile_OpenENoDB(char *filename, char *env, P7_HMMFILE **ret_hfp, char *errbuf);
extern "C" int  p7_hmmfile_Open     (char *filename, char *env, P7_HMMFILE **ret_hfp); /* deprecated */
extern "C" int  p7_hmmfile_OpenNoDB (char *filename, char *env, P7_HMMFILE **ret_hfp); /* deprecated */
extern "C" int  p7_hmmfile_OpenBuffer(char *buffer, int size, P7_HMMFILE **ret_hfp);
extern "C" void p7_hmmfile_Close(P7_HMMFILE *hfp);
#ifdef HMMER_THREADS
extern "C" int  p7_hmmfile_CreateLock(P7_HMMFILE *hfp);
#endif
extern "C" int  p7_hmmfile_WriteBinary(FILE *fp, int format, P7_HMM *hmm);
extern "C" int  p7_hmmfile_WriteASCII (FILE *fp, int format, P7_HMM *hmm);
extern "C" int  p7_hmmfile_WriteToString (char **s, int format, P7_HMM *hmm);
extern "C" int  p7_hmmfile_Read(P7_HMMFILE *hfp, ESL_ALPHABET **ret_abc,  P7_HMM **opt_hmm);
extern "C" int  p7_hmmfile_PositionByKey(P7_HMMFILE *hfp, const char *key);
extern "C" int  p7_hmmfile_Position(P7_HMMFILE *hfp, const off_t offset);
...
/* p7_msvdata.c */
extern "C" P7_SCOREDATA   *p7_hmm_ScoreDataCreate(P7_OPROFILE *om, P7_PROFILE *gm );
extern "C" P7_SCOREDATA   *p7_hmm_ScoreDataClone(P7_SCOREDATA *src, int K);
extern "C" int            p7_hmm_ScoreDataComputeRest(P7_OPROFILE *om, P7_SCOREDATA *data );
extern "C" void           p7_hmm_ScoreDataDestroy( P7_SCOREDATA *data );
extern "C" int            p7_hmm_initWindows (P7_HMM_WINDOWLIST *list);
extern "C" P7_HMM_WINDOW *p7_hmm_newWindow (P7_HMM_WINDOWLIST *list, uint32_t id, uint32_t pos, uint32_t fm_pos, uint16_t k, uint32_t length, float score, uint8_t complementarity);



/* p7_null3.c */
extern "C" void p7_null3_score(const ESL_ALPHABET *abc, const ESL_DSQ *dsq, P7_TRACE *tr, int start, int stop, P7_BG *bg, float *ret_sc);
extern "C" void p7_null3_windowed_score(const ESL_ALPHABET *abc, const ESL_DSQ *dsq, int start, int stop, P7_BG *bg, float *ret_sc);

/* p7_pipeline.c */
extern "C" P7_PIPELINE *p7_pipeline_Create(ESL_GETOPTS *go, int M_hint, int L_hint, int long_targets, enum p7_pipemodes_e mode);
extern "C" int          p7_pipeline_Reuse  (P7_PIPELINE *pli);
extern "C" void         p7_pipeline_Destroy(P7_PIPELINE *pli);
extern "C" int          p7_pipeline_Merge  (P7_PIPELINE *p1, P7_PIPELINE *p2);

extern "C" int p7_pli_ExtendAndMergeWindows (P7_OPROFILE *om, const P7_SCOREDATA *msvdata, P7_HMM_WINDOWLIST *windowlist, float pct_overlap);
extern "C" int p7_pli_TargetReportable  (P7_PIPELINE *pli, float score,     double lnP);
extern "C" int p7_pli_DomainReportable  (P7_PIPELINE *pli, float dom_score, double lnP);

extern "C" int p7_pli_TargetIncludable  (P7_PIPELINE *pli, float score,     double lnP);
extern "C" int p7_pli_DomainIncludable  (P7_PIPELINE *pli, float dom_score, double lnP);
extern "C" int p7_pli_NewModel          (P7_PIPELINE *pli, const P7_OPROFILE *om, P7_BG *bg);
extern "C" int p7_pli_NewModelThresholds(P7_PIPELINE *pli, const P7_OPROFILE *om);
extern "C" int p7_pli_NewSeq            (P7_PIPELINE *pli, const ESL_SQ *sq);
extern "C" int p7_Pipeline              (P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, const ESL_SQ *sq, P7_TOPHITS *th);
extern "C" int p7_Pipeline_LongTarget   (P7_PIPELINE *pli, P7_OPROFILE *om, P7_SCOREDATA *data,
...
extern "C" int p7_pli_Statistics(FILE *ofp, P7_PIPELINE *pli, ESL_STOPWATCH *w);


/* p7_prior.c */
extern "C" P7_PRIOR  *p7_prior_CreateAmino(void);
extern "C" P7_PRIOR  *p7_prior_CreateNucleic(void);
extern "C" P7_PRIOR  *p7_prior_CreateLaplace(const ESL_ALPHABET *abc);
extern "C" void       p7_prior_Destroy(P7_PRIOR *pri);

extern "C" int        p7_ParameterEstimation(P7_HMM *hmm, const P7_PRIOR *pri);

/* p7_profile.c */
extern "C" P7_PROFILE *p7_profile_Create(int M, const ESL_ALPHABET *abc);
extern "C" P7_PROFILE *p7_profile_Clone(const P7_PROFILE *gm);
extern "C" int         p7_profile_Copy(const P7_PROFILE *src, P7_PROFILE *dst);
extern "C" int         p7_profile_SetNullEmissions(P7_PROFILE *gm);
extern "C" int         p7_profile_Reuse(P7_PROFILE *gm);
extern "C" size_t      p7_profile_Sizeof(P7_PROFILE *gm);
extern "C" void        p7_profile_Destroy(P7_PROFILE *gm);
extern "C" int         p7_profile_IsLocal(const P7_PROFILE *gm);
extern "C" int         p7_profile_IsMultihit(const P7_PROFILE *gm);
extern "C" int         p7_profile_GetT(const P7_PROFILE *gm, char st1, int k1, 
				   char st2, int k2, float *ret_tsc);
extern "C" int         p7_profile_Validate(const P7_PROFILE *gm, char *errbuf, float tol);
extern "C" int         p7_profile_Compare(P7_PROFILE *gm1, P7_PROFILE *gm2, float tol);

/* p7_spensemble.c */
P7_SPENSEMBLE *p7_spensemble_Create(int init_n, int init_epc, int init_sigc);
extern "C" int     p7_spensemble_Reuse(P7_SPENSEMBLE *sp);
extern "C" int     p7_spensemble_Add(P7_SPENSEMBLE *sp, int sampleidx, int i, int j, int k, int m);
extern "C" int     p7_spensemble_Cluster(P7_SPENSEMBLE *sp, 
				     float min_overlap, int of_smaller, int max_diagdiff, 
				     float min_posterior, float min_endpointp,
				     int *ret_nclusters);
extern "C" int     p7_spensemble_GetClusterCoords(P7_SPENSEMBLE *sp, int which,
					      int *ret_i, int *ret_j, int *ret_k, int *ret_m, float *ret_p);
extern "C" void    p7_spensemble_Destroy(P7_SPENSEMBLE *sp);

/* p7_tophits.c */
extern "C" P7_TOPHITS *p7_tophits_Create(void);
extern "C" int         p7_tophits_Grow(P7_TOPHITS *h);
extern "C" int         p7_tophits_CreateNextHit(P7_TOPHITS *h, P7_HIT **ret_hit);
extern "C" int         p7_tophits_Add(P7_TOPHITS *h,
				  ...
				  int domidx, int ndom,
				  P7_ALIDISPLAY *ali);
extern "C" int         p7_tophits_SortBySortkey(P7_TOPHITS *h);
extern "C" int         p7_tophits_SortBySeqidxAndAlipos(P7_TOPHITS *h);
extern "C" int         p7_tophits_SortByModelnameAndAlipos(P7_TOPHITS *h);

extern "C" int         p7_tophits_Merge(P7_TOPHITS *h1, P7_TOPHITS *h2);
extern "C" int         p7_tophits_GetMaxPositionLength(P7_TOPHITS *h);
extern "C" int         p7_tophits_GetMaxNameLength(P7_TOPHITS *h);
extern "C" int         p7_tophits_GetMaxAccessionLength(P7_TOPHITS *h);
extern "C" int         p7_tophits_GetMaxShownLength(P7_TOPHITS *h);
extern "C" void        p7_tophits_Destroy(P7_TOPHITS *h);

extern "C" int p7_tophits_ComputeNhmmerEvalues(P7_TOPHITS *th, double N, int W);
extern "C" int p7_tophits_RemoveDuplicates(P7_TOPHITS *th, int using_bit_cutoffs);
extern "C" int p7_tophits_Threshold(P7_TOPHITS *th, P7_PIPELINE *pli);
extern "C" int p7_tophits_CompareRanking(P7_TOPHITS *th, ESL_KEYHASH *kh, int *opt_nnew);
extern "C" int p7_tophits_Targets(FILE *ofp, P7_TOPHITS *th, P7_PIPELINE *pli, int textw);
extern "C" int p7_tophits_Domains(FILE *ofp, P7_TOPHITS *th, P7_PIPELINE *pli, int textw);
extern "C" int p7_tophits_Alignment(const P7_TOPHITS *th, const ESL_ALPHABET *abc, 
				ESL_SQ **inc_sqarr, P7_TRACE **inc_trarr, int inc_n, int optflags,
				ESL_MSA **ret_msa);
extern "C" int p7_tophits_TabularTargets(FILE *ofp, char *qname, char *qacc, P7_TOPHITS *th, P7_PIPELINE *pli, int show_header);
extern "C" int p7_tophits_TabularDomains(FILE *ofp, char *qname, char *qacc, P7_TOPHITS *th, P7_PIPELINE *pli, int show_header);
extern "C" int p7_tophits_TabularXfam(FILE *ofp, char *qname, char *qacc, P7_TOPHITS *th, P7_PIPELINE *pli);
extern "C" int p7_tophits_TabularTail(FILE *ofp, const char *progname, enum p7_pipemodes_e pipemode, 
				  const char *qfile, const char *tfile, const ESL_GETOPTS *go);
extern "C" int p7_tophits_AliScores(FILE *ofp, char *qname, P7_TOPHITS *th );

/* p7_trace.c */
extern "C" P7_TRACE *p7_trace_Create(void);
extern "C" P7_TRACE *p7_trace_CreateWithPP(void);
extern "C" int  p7_trace_Reuse(P7_TRACE *tr);
extern "C" int  p7_trace_Grow(P7_TRACE *tr);
extern "C" int  p7_trace_GrowIndex(P7_TRACE *tr);
extern "C" int  p7_trace_GrowTo(P7_TRACE *tr, int N);
extern "C" int  p7_trace_GrowIndexTo(P7_TRACE *tr, int ndom);
extern "C" void p7_trace_Destroy(P7_TRACE *tr);
extern "C" void p7_trace_DestroyArray(P7_TRACE **tr, int N);

extern "C" int  p7_trace_GetDomainCount   (const P7_TRACE *tr, int *ret_ndom);
extern "C" int  p7_trace_GetStateUseCounts(const P7_TRACE *tr, int *counts);
extern "C" int  p7_trace_GetDomainCoords  (const P7_TRACE *tr, int which, int *ret_i1, int *ret_i2,
				       int *ret_k1, int *ret_k2);

extern "C" int   p7_trace_Validate(const P7_TRACE *tr, const ESL_ALPHABET *abc, const ESL_DSQ *dsq, char *errbuf);
extern "C" int   p7_trace_Dump(FILE *fp, const P7_TRACE *tr, const P7_PROFILE *gm, const ESL_DSQ *dsq);
extern "C" int   p7_trace_Compare(P7_TRACE *tr1, P7_TRACE *tr2, float pptol);
extern "C" int   p7_trace_Score(P7_TRACE *tr, ESL_DSQ *dsq, P7_PROFILE *gm, float *ret_sc);
extern "C" int   p7_trace_SetPP(P7_TRACE *tr, const P7_GMX *pp);
extern "C" float p7_trace_GetExpectedAccuracy(const P7_TRACE *tr);

extern "C" int  p7_trace_Append(P7_TRACE *tr, char st, int k, int i);
extern "C" int  p7_trace_AppendWithPP(P7_TRACE *tr, char st, int k, int i, float pp);
extern "C" int  p7_trace_Reverse(P7_TRACE *tr);
extern "C" int  p7_trace_Index(P7_TRACE *tr);

extern "C" int  p7_trace_FauxFromMSA(ESL_MSA *msa, int *matassign, int optflags, P7_TRACE **tr);
extern "C" int  p7_trace_Doctor(P7_TRACE *tr, int *opt_ndi, int *opt_nid);

extern "C" int  p7_trace_Count(P7_HMM *hmm, ESL_DSQ *dsq, float wt, P7_TRACE *tr);


/* seqmodel.c */
extern "C" int p7_Seqmodel(const ESL_ALPHABET *abc, ESL_DSQ *dsq, int M, char *name,
		       ESL_DMATRIX *P, float *f, double popen, double pextend,
		       P7_HMM **ret_hmm);

/* fm_alphabet.c */
extern "C" int fm_alphabetCreate (FM_METADATA *meta, uint8_t *alph_bits);
extern "C" int fm_alphabetDestroy (FM_METADATA *meta);
extern "C" int fm_reverseString (char *str, int N);
extern "C" int fm_getComplement (char c, uint8_t alph_type);


/* fm_general.c */
extern "C" uint64_t fm_computeSequenceOffset (const FM_DATA *fms, const FM_METADATA *meta, int block, uint64_t pos);
extern "C" int fm_getOriginalPosition (const FM_DATA *fms, const FM_METADATA *meta, int fm_id, int length, int direction, uint64_t fm_pos,
                                    uint32_t *segment_id, uint64_t *seg_pos);
extern "C" int fm_readFMmeta( FM_METADATA *meta);
extern "C" int fm_FM_read( FM_DATA *fm, FM_METADATA *meta, int getAll );
extern "C" void fm_FM_destroy ( FM_DATA *fm, int isMainFM);
extern "C" uint8_t fm_getChar(uint8_t alph_type, int j, const uint8_t *B );
extern "C" int fm_getSARangeReverse( const FM_DATA *fm, FM_CFG *cfg, char *query, char *inv_alph, FM_INTERVAL *interval);
extern "C" int fm_getSARangeForward( const FM_DATA *fm, FM_CFG *cfg, char *query, char *inv_alph, FM_INTERVAL *interval);
extern "C" int fm_configAlloc(FM_CFG **cfg);
extern "C" int fm_configDestroy(FM_CFG *cfg);
extern "C" int fm_metaDestroy(FM_METADATA *meta );
extern "C" int fm_updateIntervalForward( const FM_DATA *fm, const FM_CFG *cfg, char c, FM_INTERVAL *interval_f, FM_INTERVAL *interval_bk);
extern "C" int fm_updateIntervalReverse( const FM_DATA *fm, const FM_CFG *cfg, char c, FM_INTERVAL *interval);
extern "C" int fm_initSeeds (FM_DIAGLIST *list) ;
extern "C" FM_DIAG * fm_newSeed (FM_DIAGLIST *list);
extern "C" int fm_initAmbiguityList (FM_AMBIGLIST *list);
extern "C" int fm_addAmbiguityRange (FM_AMBIGLIST *list, uint32_t start, uint32_t stop);
extern "C" int fm_convertRange2DSQ(const FM_DATA *fm, const FM_METADATA *meta, uint64_t first, int length, int complementarity, ESL_SQ *sq, int fix_ambiguities );
extern "C" int fm_initConfigGeneric( FM_CFG *cfg, ESL_GETOPTS *go);

/* fm_ssv.c */
extern "C" int p7_SSVFM_longlarget( P7_OPROFILE *om, float nu, P7_BG *bg, double F1,
                      const FM_DATA *fmf, const FM_DATA *fmb, FM_CFG *fm_cfg, const P7_SCOREDATA *ssvdata,
                      int strands, P7_HMM_WINDOWLIST *windowlist);


/* fm_sse.c */
extern "C" int fm_configInit      (FM_CFG *cfg, ESL_GETOPTS *go);
extern "C" int fm_getOccCount     (const FM_DATA *fm, const FM_CFG *cfg, int pos, uint8_t c);
extern "C" int fm_getOccCountLT   (const FM_DATA *fm, const FM_CFG *cfg, int pos, uint8_t c, uint32_t *cnteq, uint32_t *cntlt);
